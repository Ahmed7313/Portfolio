    ...
    for (let key in projects) {
      ...
      craftCard.innerHTML = `
        ...
        <div class="p-6">
          ...
          <a href="Crafts/project.html?id=${project.id}" class="inline-flex items-center px-4 py-2 bg-yellow-600 hover:bg-yellow-700 text-white rounded-full btn-animate">
